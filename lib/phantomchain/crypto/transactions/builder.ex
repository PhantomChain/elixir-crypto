defmodule PhantomChain.Crypto.Transactions.Builder do
  alias PhantomChain.Crypto.Configuration.Fee
  alias PhantomChain.Crypto.Enums.Types
  alias PhantomChain.Crypto.Identities.{Address, PublicKey}
  alias PhantomChain.Crypto.Transactions.Transaction
  alias PhantomChain.Crypto.Utils.Slot
