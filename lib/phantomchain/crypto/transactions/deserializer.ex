defmodule PhantomChain.Crypto.Transactions.Deserializer do
  alias PhantomChain.Crypto.Enums.Types
  alias PhantomChain.Crypto.Identities.Address
  alias PhantomChain.Crypto.Transactions.Deserializers.DelegateRegistration
  alias PhantomChain.Crypto.Transactions.Deserializers.DelegateResignation
  alias PhantomChain.Crypto.Transactions.Deserializers.IPFS
  alias PhantomChain.Crypto.Transactions.Deserializers.MultiPayment
  alias PhantomChain.Crypto.Transactions.Deserializers.MultiSignatureRegistration
  alias PhantomChain.Crypto.Transactions.Deserializers.SecondSignatureRegistration
  alias PhantomChain.Crypto.Transactions.Deserializers.TimelockTransfer
  alias PhantomChain.Crypto.Transactions.Deserializers.Transfer
  alias PhantomChain.Crypto.Transactions.Deserializers.Vote
